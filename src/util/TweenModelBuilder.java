...
public interface TweenModelBuilder<AnimatorModel> {
   ...
   */
  TweenModelBuilder<AnimatorModel> addOval(
          String name,
          float cx, float cy,
   ...
   * @return the builder object
   */
  TweenModelBuilder<AnimatorModel> addRectangle(
          String name,
          float lx, float ly,
   ...
   */
  TweenModelBuilder<AnimatorModel> addMove(
          String name,
   ...
   */
  TweenModelBuilder<AnimatorModel> addColorChange(
          String name,
   ...
   */
  TweenModelBuilder<AnimatorModel> addScaleToChange(String name, float fromSx, float
